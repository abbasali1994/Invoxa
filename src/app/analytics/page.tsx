...
export default function AnalyticsPage() {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[70vh]">
        ...
        <p className="text-neutral-400 max-w-md text-center">
          GPT-OSS 120B is crunching your invoices, expenses, settlements, and FX rates to build a comprehensive intelligence report. This usually takes 5-10 seconds.
        </p>
      </div>
    )
  }
    ...
    return (
      <div className="space-y-6 pb-20">
        <PageHeader
          ...
          subtitle="Generated by GPT-OSS 120B on Groq"
          actions={
            <>
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        title="AI Financial Intelligence"
        subtitle="Generate a deeply insightful, brutally honest, and actionable financial report powered by GPT-OSS 120B."
